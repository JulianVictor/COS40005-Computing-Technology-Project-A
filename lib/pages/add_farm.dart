...
class _AddFarmPageState extends State<AddFarmPage> {
  ...
  void _addFarm() async {
    ...
    try {
      ...
      // Create FarmSelection object
      final newFarm = FarmSelection(
        farmId: '', // Will be generated by Supabase
      ...
      // Save to Supabase using FarmSelectionService
      final farmService = FarmSelectionService(); // ADD THIS
      final savedFarm = await farmService.addFarm(newFarm); // CHANGE THIS
      ...
      if (savedFarm != null) {
        ...
        Navigator.pop(context, savedFarm); // Return FarmSelection
      } else {
        _showError('Failed to create farm');
      }
